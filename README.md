...
This project was completed as part of the ['Differential Expression Analysis with limma in R'](https://app.datacamp.com/learn/courses/differential-expression-analysis-with-limma-in-r) course on DataCamp. The project covers preprocessing, normalization, model fitting, contrasts, and pathway enrichment using the limma package.
